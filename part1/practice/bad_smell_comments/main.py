...
class Unit:
    # ...
    def move(self, field, feld_1_param, field_2_param, d, fl, cr, points_per_action=1):
        ...
        if fl:  # для начала реализуем логику для состояния когда мы летим
            # раз мы летим то сцепления наших тапочек с землей нет, и следовательно трение меньше, и поэтому скорость выше
            points_per_action *= 1.2
            if d == 'UP':  # если направление нашего движения установлено как UP
                # увеличим нашу координату Y на нашу текущую скорость
                ...
                # уменьшим нашу координату Y на нашу текущую скорость
                new_y = field_2_param - points_per_action
                new_x = feld_1_param  # оставим нашу координату Х без изменений
